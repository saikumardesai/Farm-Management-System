	...
	?>
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">Farm management system <span>Vormir</span></p>
			</div>
			<div>
			...
			<div>
				...
				<p style="font-size:20px"><a href="mailto:Farmmanagementsysteme@gmail.com" style="color:white">demo@demo.com</a></p>
			</div>
		</div>

		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>About Farm Management System</b></span>
				Farm management system  is e-commerce trading platform for grains & grocerries...
			</p>
