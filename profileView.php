        ...
        <section id="one" class="wrapper style1 align">
            <div class="inner">
                ...
                <header>
                    <center>
                  <span>
    <!--<img src="<?php echo 'images/profileImages/'.$_SESSION['productPicName'].'?'.mt_rand(); ?>" class="img-circle img-responsive" height="200%">-->
    <img src="images/profileImages/profile0.png" class="image" height="200%">
</span>
