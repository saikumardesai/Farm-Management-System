...
while ($row = $result->fetch_array()) {
    ...
    if ($row1 && isset($row1['pimage'])) { // Check if $row1 is not null and 'pimage' is set
        $picDestination = "images/productImages/" . $row1['pimage'];
    } else {
        // Handle the case where 'pimage' is null or not set
        $picDestination = "images/productImages/default.jpg"; // Set a default image or handle as needed
    }
}
?>
